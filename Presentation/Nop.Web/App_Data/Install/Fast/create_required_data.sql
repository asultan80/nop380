...
INSERT [dbo].[MessageTemplate] ([Id], [Name], [BccEmailAddresses], [Subject], [Body], [IsActive], [DelayBeforeSend], [DelayPeriodId], [AttachedDownloadId], [EmailAccountId], [LimitedToStores]) VALUES (30, N'OrderPlaced.VendorSmsNotification', NULL, N'EazyBuy: new order # %Order.OrderNumber%', N'New order has been received. Please check your order on EazyBuy: %Store.URL%Admin/Order/Edit/%Order.OrderNumber%', 0, NULL, 0, 0, 1, 0)
